...
void loop() {
  ...
  if (rf_driver.recv(buf, &buflen)) {
    ...
    Serial.println(strHum.toInt());
    Serial.println(strTemp.toInt()); 
    Serial.println(strAx.toFloat());
    Serial.println(strAy.toFloat());
    Serial.println(strAz.toFloat());
  }
}
